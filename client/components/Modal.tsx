...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 弹窗内容 - 红黑风格 */}
      <div
        className={`relative bg-gradient-to-b from-neutral-900 to-red-950 border border-red-500/30 rounded-2xl shadow-2xl w-full ${sizeClasses} max-h-[90vh] overflow-y-auto scroll-none ${getAnimationClasses()}`}
        ...
        {(title || showCloseButton) && (
          <div className="flex items-center justify-between p-6 border-b border-red-500/30">
            ...
            {showCloseButton && (
              <button
                onClick={handleClose}
                className="text-gray cursor-pointer ml-auto px-3 py-1 bg-red-500/20 rounded-full transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-neutral-900"
                aria-label="关闭弹窗"
              >
                关闭
              </button>
