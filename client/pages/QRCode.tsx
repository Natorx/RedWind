...
const copyQRCode = async () => {
  ...
  return (
    <PageBox>
      ...
      {/* 输入框 */}
      <div className="bg-transparent rounded-lg shadow-lg border border-red-500/20 overflow-hidden backdrop-blur-sm">
        <div className=" rounded-lg shadow-lg overflow-hidden backdrop-blur-sm">
          <div className="flex justify-between items-start p-4">
            <textarea
              value={text}
              onChange={(e) => setText(e.target.value)}
              className="w-70% h-10 p-3 bg-transparent border-none rounded-lg 
                           text-neutral-200 placeholder:text-neutral-500 outline-none resize-none"
      ...
      {/* 二维码信息 */}
      <div className="w-full px-15% my-2 flex justify-around items-center  rounded-lg border border-red-500/20 p-4 backdrop-blur-sm">
        {/* 操作按钮 */}
